import { contactus } from "../services/customerapiservice";
...
export function ContactUs() {
  ...
  function handleSubmit(event) {
    ...
    const response = contactus(updateData);
    if (response) {
      alert(
        "Thank you for the opportunity !! Looking forward to work with XENONSTACK!"
      );
    }
  }
  ...
  return (
    <div style={{ background: "linear-gradient(-180deg, #c3e8a7, #bbe2ed)" }}>
      <div className="container" style={{ height: "160vh" }}>
        ...
        <main
          className="form-signin w-100 m-auto my-5"
          style={{
            background: "white",
            maxWidth: 800,
        ...
        >
          ...
          >
            <p>
              Write in if you have any business proposals, queries, complaints
              or suggestions. <br />
