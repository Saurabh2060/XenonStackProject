...
export class Register extends Component {
    ...
    if (this.state.formData.name == "") {
      ...
      <>
        ...
        <Showmodal show="true">
          ...
          <p>Email id should be in correct format</p>
        </Showmodal>
      </>;
    } else {
  ...
  render() {
    return (
      ...
      >
        <main
          className="form-signin w-100 m-auto mb-5"
          style={{
            background: "white",
            maxWidth: 520,
            boxShadow: "0 0 16px rgb(0 0 0 / 30%)",
          }}
        >
          <form style={{ textAlign: "center", padding: "5vh" }} id="formstyle">
            ...
            <div className="form-floating">
              <input
                ...
                {...(this.state.validemail
                  ? { className: "form-floating form-control is-invalid" }
                  : "")}
            ...
            <div className="d-flex justify-content-center mt-4 mr-5">
              <h5>
